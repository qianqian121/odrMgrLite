/*
 * Copyright 2007-2015 VIRES Simulationstechnologie GmbH
 * ALL RIGHTS RESERVED
 *
...
OpenDRIVE Manager 1.4, Lite Edition, July 20, 2015
--------------------------------------------------
...
- Linux, 32bit              lib/Linux/lib32
- Linux, 64bit              lib/Linux/lib64
- Windows, VS2013, 32bit    lib/Windows/VS2013-32/Debug
                            lib/Windows/VS2013-32/DynamicDebug
                            lib/Windows/VS2013-32/DynamicRelease
                            lib/Windows/VS2013-32/Release
- Windows, VS2013, 64bit    lib/Windows/VS2013-64/Debug
                            lib/Windows/VS2013-64/DynamicDebug
                            lib/Windows/VS2013-64/DynamicRelease
                            lib/Windows/VS2013-64/Release

    
Compile the example and link it to the enclosed library <libODriveLite.1.4.3.a>

You can do this from the command line (here: 32bit Linux machine) with

    g++ -m32 -o odrTest src/main.cc -Iinc -Llib/Linux/lib32 -lODriveLite.1.4.3
